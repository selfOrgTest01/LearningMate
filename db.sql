...
CREATE TABLE courses (
    ...
    CONSTRAINT courses_user_id_fk FOREIGN KEY (user_id) REFERENCES users(user_id) 
    ON UPDATE CASCADE
    ON DELETE CASCADE
)
...
INSERT INTO courses (title, category, content, user_id, attach_file_path, attach_file_name)
VALUES ('강의 제목', '강의 카테고리', '강의 내용', 15, '/path/to/attach/file', 'attach_file_name');
...
INSERT INTO comments (course_id, user_id, content)
VALUES (1, 19, '강의 댓글 테스트!!');
...
CREATE Table bookmark (
    ...
    CONSTRAINT bookmark_user_id_fk FOREIGN KEY (user_id) REFERENCES users(user_id)
    ON UPDATE CASCADE
    ON DELETE CASCADE
)
...
WHERE bookmarks.user_id = 15;

INSERT INTO bookmark (user_id, course_id, status) VALUES (15, 1, 1);