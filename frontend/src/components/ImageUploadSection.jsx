    ...
    return (
        <>
            <Container className=' d-flex justify-content-center align-items-center flex-column'>
                ...
                <h1>ImageUploader</h1>
                <img src={image} width='300' height='300' img='img' alt='uploadImage' />
                <br />
                <input
                    type='file'
                    id='imgInput'
                ...
                <ButtonGroup>
                    ...
                    <Button variant='danger' size='sm' onClick={fn_delete_image}>
                        삭제
                    </Button>
                    <Button variant='success' size='sm' onClick={fn_register_image}>
                        등록
                    </Button>
                    <Button variant='success' size='sm' onClick={fn_read_imageUrl}>
                        읽어오기 테스트
                    </Button>
                </ButtonGroup>
            </Container>
