...
const Workspace = () => {
  ...
  const { chatRoomInfo, error: chatRoomError } = useSWR(userData ? `/api/chat/chatRoom/${workspace}` : null, fetcher);
    ...
    <div>
      ...
      <WorkspaceWrapper>
        ...
        <Chats>
          ...
          <Navigate>
            <Route path='/workspace/:workspace/channel/:channel' element={<TypingChat />} />
